...
function TaskList() {
  ...
  const loadTableData = (response) => {
    ...
    if (valueSearch) {
      ...
      const filteredData = data.filter((task) =>
        task.taskName.toLowerCase().includes(taskNameParameter)
      );
        ...
        (valueSearch
          ? task.taskName.toLowerCase().includes(valueSearch.toLowerCase()) ||
            task.managers.some((manager) =>
              manager.toLowerCase().includes(valueSearch.toLowerCase())
            )
          : task.taskName) &&
        (milestone
      ...
      (task) =>
        (value
          ? task.taskName.toLowerCase().includes(value) ||
            task.managers.some((manager) =>
              manager.toLowerCase().includes(value)
            )
          : task.taskName) &&
        (category
          ? !task.category_name.localeCompare(category)
  ...
  const FilterByStatus = (value) => {
    ...
    const filteredData = originalData.filter(
      (task) =>
        (value ? !task.status.localeCompare(value) : task.status) &&
        (valueSearch
          ? task.taskName.toLowerCase().includes(valueSearch.toLowerCase()) ||
            task.managers.some((manager) =>
              manager.toLowerCase().includes(valueSearch.toLowerCase())
