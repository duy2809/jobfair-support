...
export const getMilestonesList = () => instance.get(`/schedules/all-milestones/`);
export const getTemplateTaskList = () => instance.get(`/schedules/all-template-tasks/`);
...
export const postCheckExistName = (argument) => instance.post(`/schedules/checkScheduleNameExist`, argument);
